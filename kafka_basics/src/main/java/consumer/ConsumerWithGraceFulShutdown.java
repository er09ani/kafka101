...
public class ConsumerWithGraceFulShutdown {
    private static final Logger log = LoggerFactory.getLogger(ConsumerWithGraceFulShutdown.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        Runtime.getRuntime().addShutdownHook(
                new Thread(() -> {
                    log.info("Shutting down... so calling consumer wakeup");
                    consumer.wakeup();
                    try {
                        mainThread.join();
